...
ActiveRecord::Schema.define(version: 2024_08_24_080615) do
  ...
  create_table "language_tag_relations", force: :cascade do |t|
    t.integer "language_id", null: false
    t.integer "tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["language_id"], name: "index_language_tag_relations_on_language_id"
    t.index ["tag_id"], name: "index_language_tag_relations_on_tag_id"
  end
